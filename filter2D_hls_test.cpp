...
#define INPUT_IMG "../../../../../E_Elements_labs/src/ip/hls/filter2D/lena_gray.bmp"
...
int main() {
	...
	filter2D_hls(input_data,output_data,imgSrc.rows,imgSrc.cols,CH,0,r1,r2,r3);
	...
	cv::Sobel(imgSrc,imgcalc,-1,1,0,3);		//generate test image
